    ...
    <section className="bg-hero py-20 md:py-32">
      <div className="max-w-7xl mx-auto flex flex-col gap-12 md:gap-20 items-center px-4">
        ...
        <div className="w-full">
          <h3 className="calistoga text-center text-background text-3xl mb-8">
            Need Help?
          </h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            <a
              ...
              className="flex flex-col p-6 rounded-3xl text-background bg-header-scroll transition-all duration-300 hover:bg-header-scroll/80 hover:-translate-y-1"
            >
